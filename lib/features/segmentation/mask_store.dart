...
class MaskStore {
  ...
  /// Expands an [AlphaMask] to opaque-white RGBA bytes (alpha = coverage). Pure
  /// CPU work; run off the UI isolate by [encodePng].
  static Uint8List _alphaToRgba(AlphaMask mask) {
