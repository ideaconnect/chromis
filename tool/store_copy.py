...
CAPTIONS = {
    ...
    "pl": {
        ...
        "objremove_panel": ("Dotknij obiektu,\naby go usunąć",
                            "Model segmentacji sam znajdzie jego kontur.\nCofnięcie przywraca go z powrotem."),
    ...
    "de": {
        ...
        "objremove_panel": ("Objekt antippen,\nund es ist weg",
                            "Das Segmentierungsmodell findet seine Kontur.\nRückgängig holt es zurück."),
        "bubble": ("Texte und\nComic-Blasen",
    ...
    "es": {
        ...
        "objremove_panel": ("Toca un objeto\npara quitarlo",
                            "El modelo de segmentación halla su contorno.\nDeshacer lo devuelve."),
        "bubble": ("Textos y\nbocadillos de cómic",
    ...
    "fr": {
        ...
        "objremove_panel": ("Touchez un objet\npour l'effacer",
                            "Le modèle de segmentation trouve son contour.\nAnnuler le fait revenir."),
        "bubble": ("Légendes et\nbulles de BD",
    ...
    "cs": {
        ...
        "objremove_panel": ("Klepněte na objekt\na zmizí",
                            "Segmentační model sám najde jeho obrys.\nZpět jej vrátí."),
        "bubble": ("Popisky a\nkomiksové bubliny",
